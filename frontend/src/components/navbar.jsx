...
import TransitionWrapper from "./ui/wrappers/transition-wrapper";
...
setCredentials(null);
  ...
  return (
    <Menu as='div' className='relative  z-50 '>
      ...
      <TransitionWrapper>
        <Menu.Items className='absolute z-50 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white dark:bg-white-800 shadow-lg ring-1 ring-black/5 focus:outline-none'>
...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex items-center justify-between py-6 dark:bg-slate-800'>
      <Link to='/'>
        <div className='flex items-center gap-2 cursor-pointer'>
          <div className='w-10 md:w-12 h-10 md:h-12 flex items-center justify-center bg-violet-700 rounded-xl'>
            <GiWallet className='text-white text-3xl hover:animate-spin' />
          </div>
